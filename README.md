...
Серверная часть — отдельный репозиторий (Kotlin, Spring Boot, PostgreSQL, Liquibase, Docker).
...
Требования: Android Studio с поддержкой AGP 8.7, Android SDK 35, JDK 17.

1. Запустить бэкенд из соседнего репозитория:
   ```bash
